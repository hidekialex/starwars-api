...
public class PlanetController {
    ...
    @GetMapping("/{id}")
    public PlanetInfoResponse getPlanetById(@PathVariable String id) throws PlanetNotFoundException {
    ...
    @DeleteMapping("/{id}")
    public RemovePlanetResponse remove(@PathVariable String id) {
